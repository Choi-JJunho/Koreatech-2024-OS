#include "matmult/matmult_single_thread.h"
#include "matmult/matmult_threaded.h"

int main() {
    /*TODO
     * 쓰레드 16개(4x4블록)를 사용해서 A, B, C 세 개의 행렬이 모두 NxN 행렬이라고 가정하고
     * 1024x1024, 1500x1500, 2000x2000, 2048x2048의 행렬 곱셉을 수행하는 프로그램을 작성하시오.
     */
    execute_matmult_multi_thread(false);
     ...
     */
    execute_matmult_single_thread(false);
}